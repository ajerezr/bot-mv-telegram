...
icondict = {}
icondict['01d']=' \U00002600'
icondict['01n']=' \U0001F31B'
icondict['02d']=' \U000026C5'
icondict['02n']=' \U0001F31B'+'\U00002601'
icondict['03d']=' \U00002601'
icondict['03n']=' \U00002601'
icondict['04d']=' \U00002601'+'\U00002601'
icondict['04n']=' \U00002601'+'\U00002601'
icondict['09d']=' \U00002614'+'\U00002614'
icondict['09n']=' \U00002614'+'\U00002614'
icondict['10d']=' \U00002614'+'\U00002600'+'\U00002601'
icondict['10n']=' \U00002614'+'\U0001F31B'+'\U00002601'
icondict['11d']=' \U00002614'+'\U00002601'+'\U0001F4A8'+'\U000026A1'
icondict['11n']=' \U00002614'+'\U00002601'+'\U0001F4A8'+'\U000026A1'
icondict['13d']=' \U00002744'+'\U00002744'
icondict['13n']=' \U00002744'+'\U00002744'
icondict['50d']=' \U0001F301'
icondict['50n']=' \U0001F301'
...
def format_msg(son,data):
    ...
    msg['cords'] = "*Lat:*"+str(son['city']['coord']['lat'])+" "+"*long:*"+str(son['city']['coord']['lon'])+"\n"
    msg['Temp_last'] = "*Temp:* "+str(son['list'][0]['main']['temp'])+"º"+"\n"
    msg['Humi_last'] = "*Humidity:* "+str(son['list'][0]['main']['humidity'])+"%"+"\n"
    msg['Prev_last'] = "*Status:* "+son['list'][0]['weather'][0]['description']+icondict[son['list'][0]['weather'][0]['icon']]+"\n"
    ...
    for items in data['datetimes']:
        if items.day == data['LastDate'].day:
            msg['full_prev']['Today'] += items.strftime('%H:%M')+" "+str(data['prevlist'][ndates])+icondict[data['iconlist'][ndates]]+'\n'
        elif items.day == (data['LastDate']+timedelta(days=1)).day:
            msg['full_prev']['Tomorrow'] += items.strftime('%H:%M')+" "+str(data['prevlist'][ndates])+icondict[data['iconlist'][ndates]]+'\n'
        elif items.day != (data['LastDate']+timedelta(days=1)).day:
            date = items.strftime('%y-%m-%d')
            if date not in msg['full_prev']:
                msg['full_prev'][date] = items.strftime('*%d of %B*')+":\n"
                msg['full_prev'][date]+=items.strftime('%H:%M')+" "+str(data['prevlist'][ndates])+icondict[data['iconlist'][ndates]]+'\n'
            else:
                msg['full_prev'][date]+=items.strftime('%H:%M')+" "+str(data['prevlist'][ndates])+icondict[data['iconlist'][ndates]]+'\n'
        ndates += 1
